...
function client_insert(){
	...
	if(function_exists('client_after_insert')){
		$res = sql("select * from `client` where `id`='" . makeSafe($recID, false) . "' limit 1", $eo);
...
function client_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$res = sql("select `id` from `client` where `id`='$selected_id'", $eo);
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `property` where `client_id`='".addslashes($id[0])."'", $eo);
	...
	sql("delete from `client` where `id`='$selected_id'", $eo);
...
function client_update($selected_id){
	...
	if(function_exists('client_after_update')){
		$res = sql("SELECT * FROM `client` WHERE `id`='{$data['selectedID']}' LIMIT 1", $eo);
		if($row = db_fetch_assoc($res)){
			$data = array_map('makeSafe', $row);
		}
...
function client_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if($selected_id){
		...
		$res = sql("select * from `client` where `id`='".makeSafe($selected_id)."'", $eo);
			...
			$j("#title-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_title__RAND__.value, t: 'client', f: 'title' },
						success: function(resp){
							...
							if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=psn_title_view_parent]').hide(); }else{ $j('.btn[id=psn_title_view_parent]').show(); }
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'title' }; },
				...
				if(e.added.id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=psn_title_view_parent]').hide(); }else{ $j('.btn[id=psn_title_view_parent]').show(); }
			...
			$j("#address_id-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_address_id__RAND__.value, t: 'client', f: 'address_id' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'address_id' }; },
					results: function(resp, page){ return resp; }
				},
				escapeMarkup: function(str){ return str; }
			}).on('change', function(e){
			...
			$j("#type1-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_type1__RAND__.value, t: 'client', f: 'type1' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'type1' }; },
					results: function(resp, page){ return resp; }
				},
				escapeMarkup: function(str){ return str; }
			}).on('change', function(e){
			...
			$j("#type2-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_type2__RAND__.value, t: 'client', f: 'type2' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'type2' }; },
					results: function(resp, page){ return resp; }
				},
				escapeMarkup: function(str){ return str; }
			}).on('change', function(e){
			...
			$j("#type3-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_type3__RAND__.value, t: 'client', f: 'type3' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'type3' }; },
					results: function(resp, page){ return resp; }
				},
				escapeMarkup: function(str){ return str; }
			}).on('change', function(e){
			...
			$j("#membergroupid-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_membergroupid__RAND__.value, t: 'client', f: 'membergroupid' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'client', f: 'membergroupid' }; },
					results: function(resp, page){ return resp; }
				},
				escapeMarkup: function(str){ return str; }
			}).on('change', function(e){
	...
	$lookup_fields = array(  'title' => array('psn_title', 'Title'), 'address_id' => array('address', 'Address id'), 'type1' => array('psn_type', 'Type1'), 'type2' => array('psn_type', 'Type2'), 'type3' => array('psn_type', 'Type3'), 'membergroupid' => array('member_group', 'Membergroupid'));
