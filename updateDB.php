<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('member_group', "create table if not exists `member_group` (   `id` SMALLINT unsigned not null auto_increment , primary key (`id`), `name` VARCHAR(40) , `description` CHAR(60) ) CHARSET utf8", $silent, array( "ALTER TABLE `table14` RENAME `member_group`","UPDATE `membership_userrecords` SET `tableName`='member_group' where `tableName`='table14'","UPDATE `membership_userpermissions` SET `tableName`='member_group' where `tableName`='table14'","UPDATE `membership_grouppermissions` SET `tableName`='member_group' where `tableName`='table14'","ALTER TABLE member_group ADD `field1` VARCHAR(40)","ALTER TABLE `member_group` CHANGE `field1` `id` VARCHAR(40) ","ALTER TABLE `member_group` CHANGE `id` `id` INT unsigned not null auto_increment ","ALTER TABLE member_group ADD `field2` VARCHAR(40)","ALTER TABLE `member_group` CHANGE `field2` `name` VARCHAR(40) ","ALTER TABLE member_group ADD `field3` VARCHAR(40)","ALTER TABLE `member_group` CHANGE `field3` `description` VARCHAR(40) ","ALTER TABLE `member_group` CHANGE `comments` `comments` TEXT "," ALTER TABLE `member_group` CHANGE `id` `id` SMALLINT unsigned not null auto_increment "," ALTER TABLE `member_group` CHANGE `description` `description` CHAR(40) "," ALTER TABLE `member_group` CHANGE `description` `description` CHAR(60) "));
