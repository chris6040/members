<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'country' table. 
	...
	*/
	...
	function country_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function country_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function country_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function country_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function country_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function country_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function country_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function country_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function country_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function country_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function country_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function country_batch_actions(&$args){
