<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'loan_type' table. 
	...
	*/
	...
	function loan_type_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function loan_type_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function loan_type_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function loan_type_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function loan_type_batch_actions(&$args){
