<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'county' table. 
	...
	*/
	...
	function county_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function county_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function county_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function county_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function county_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function county_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function county_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function county_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function county_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function county_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function county_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function county_batch_actions(&$args){
