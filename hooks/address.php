<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'address' table. 
	...
	*/
	 ...
	 *     $data['address1'], $data['address2'], $data['address3'], $data['town'], $data['county'], $data['country'], $data['postcode1'], $data['postcode2']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['address1'], $data['address2'], $data['address3'], $data['town'], $data['county'], $data['country'], $data['postcode1'], $data['postcode2']
