<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'trans_type' table. 
	...
	*/
	...
	function trans_type_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function trans_type_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['type'], $data['acc_type'], $data['description']
	...
	*/
	...
	function trans_type_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['acc_type'], $data['description']
	...
	*/
	...
	function trans_type_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function trans_type_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function trans_type_batch_actions(&$args){
