<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'psn_title' table. 
	...
	*/
	...
	function psn_title_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function psn_title_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function psn_title_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function psn_title_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function psn_title_batch_actions(&$args){
