<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'member_group' table. 
	...
	*/
	...
	function member_group_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function member_group_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function member_group_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function member_group_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function member_group_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function member_group_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function member_group_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function member_group_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function member_group_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function member_group_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function member_group_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function member_group_batch_actions(&$args){
