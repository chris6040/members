<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'property' table. 
	...
	*/
	...
	function property_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function property_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['partner_id'], $data['address_id'], $data['purchase_date'], $data['referer'], $data['detachment'], $data['type'], $data['tenancy_type'], $data['no_beds'], $data['notes']
	...
	*/
	...
	function property_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function property_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['partner_id'], $data['address_id'], $data['purchase_date'], $data['referer'], $data['detachment'], $data['type'], $data['tenancy_type'], $data['no_beds'], $data['notes']
	...
	*/
	...
	function property_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function property_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function property_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function property_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function property_batch_actions(&$args){
