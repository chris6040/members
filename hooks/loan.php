<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'loan' table. 
	...
	*/
	...
	function loan_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function loan_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function loan_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['loan_type'], $data['property_id'], $data['broker_id'], $data['date'], $data['amount'], $data['costs'], $data['apr'], $data['outstanding'], $data['lender_id'], $data['lender_ref']
	...
	*/
	...
	function loan_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function loan_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['loan_type'], $data['property_id'], $data['broker_id'], $data['date'], $data['amount'], $data['costs'], $data['apr'], $data['outstanding'], $data['lender_id'], $data['lender_ref']
	...
	*/
	...
	function loan_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function loan_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function loan_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function loan_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function loan_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function loan_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function loan_batch_actions(&$args){
