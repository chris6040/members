<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'transaction' table. 
	...
	*/
	...
	function transaction_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function transaction_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function transaction_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['date'], $data['property_id'], $data['type'], $data['amount']
	...
	*/
	...
	function transaction_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function transaction_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['date'], $data['property_id'], $data['type'], $data['amount']
	...
	*/
	...
	function transaction_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function transaction_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function transaction_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function transaction_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function transaction_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function transaction_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function transaction_batch_actions(&$args){
